...
class CutomHTMLRenderer(BaseRenderer):
    ...
    def __init__(
        ...
        super(CutomHTMLRenderer, self).__init__()
...
def parse_chunk(md: str):
    ...
    return create_markdown(renderer=CutomHTMLRenderer(), escape=True,plugins=["strikethrough", "footnotes", "table"])(md)